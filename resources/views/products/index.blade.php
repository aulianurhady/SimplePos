                                            ...
                                            <td>
                                                @if (!empty($row->foto))
                                                    <img src="{{ asset('uploads/product/' . $row->foto) }}"
                                                        alt="{{ $row->nama_produk }}" width="50px" height="50px">
                                                @else
                                                    <img src="http://via.placeholder.com/50x50" alt="{{ $row->nama_produk }}">
                                                @endif
                                            </td>
                                            <td>
                                                <sup class="label label-success">({{ $row->kode_produk }})</sup>
                                                <strong>{{ ucfirst($row->nama_produk) }}</strong>
                                            </td>
